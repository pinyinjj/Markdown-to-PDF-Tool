    ...
    def _load_translations(self) -> Dict[str, Dict[str, str]]:
        ...
        return {
            'en': {
                ...
                'pdf_processing_completed': 'PDF processing completed: {}/{} successful',
                ...
                'processing_failed_with_error': 'Processing failed: {} - {}',
                
                # 错误信息
                'watermark_image_not_found': 'Watermark image not found and text to image conversion failed',
                'no_md_files_in_directory': 'No Markdown files found in {} directory',
                'no_pdf_files_in_directory': 'No PDF files found in {} directory',
            ...
            'zh': {
                ...
                'pdf_processing_completed': 'PDF处理完成：{}/{} 成功',
                'no_pdf_files_processed': '没有成功处理任何PDF文件',
                'found_pdf_files': '找到 {} 个PDF文件',
                'processing_successful': '成功处理：{} -> {}',
                'processing_failed': '处理失败：{}',
                'processing_failed_with_error': '处理失败：{} - {}',
                
                # 错误信息
                'watermark_image_not_found': '未找到图片水印，且文本转图片失败',
                'no_md_files_in_directory': '在 {} 目录中未找到Markdown文件',
                'no_pdf_files_in_directory': '在 {} 目录中未找到PDF文件',
